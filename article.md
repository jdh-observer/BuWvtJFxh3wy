...
<!-- #region citation-manager={"citations": {"": []}} tags=["abstract"] -->
...
demo_finder.show_notebook_sequence(demo_sequences,show_limit=2, frame_resize=(70,70), convert_format='JPEG')
```
...
<!-- #region tags=["narrative", "anchor-possibilities-pitfalls"] -->
...
<!-- #region slideshow={"slide_type": ""} tags=["hermeneutics", "anchor-filter-again"] -->
...
<!-- #region slideshow={"slide_type": ""} tags=["narrative", "anchor-four-clips"] -->
...
```python slideshow={"slide_type": ""} tags=["narrative", "figure-cooking1-*"]
...
```python tags=["narrative", "figure-newspaper-*"]
...
<!-- #region slideshow={"slide_type": ""} tags=["hermeneutics", "anchor-military-exercise"] -->
...
<!-- #region slideshow={"slide_type": ""} tags=["hermeneutics", "anchor-thumbnail"] -->
...
```python tags=["narrative", "figure-diagram2-*"]
...
```python tags=["narrative", "figure-wilhelm-*"]
...
```python tags=["narrative", "figure-diagram3-*"]
...
```python tags=["narrative", "figure-explosion-*"]
...
```python tags=["narrative", "figure-sahlberg1-*"]
...
```python tags=["narrative", "figure-sahlberg2-*"]
...
```python tags=["narrative", "figure-balloon1-*"]
...
```python tags=["narrative", "figure-balloon2-*"]
